...
Primero consideramos la secuencia `arriba`, `arriba`, `derecha`, `derecha`, `derecha`. En caso que las acciones se realicen correctamente se llega a la meta con una probabilidad de $P([u\to u] \cap [u\to u] \cap [r\to r] \cap [r\to r] \cap [r\to r]) = P([u\to u])P([u\to u])P([r\to r])P([r\to r])P([r\to r]) = 0.8\times 0.8\times 0.8\times 0.8\time 0.8 = 0.8^5 = 0.32768$,
```
┏━━━━━┳━━━━━┳━━━━━┳━━━━━┓
┃→  .8┃→  .8┃→ .8 ┃✓f .8┃
┣━━━━━╋━━━━━╋━━━━━╋━━━━━┫
